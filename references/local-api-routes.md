...
Use `/connector/import` for importing BibTeX/RIS into Zotero. Treat connector writes as Zotero library modifications and confirm with the user before doing them.
